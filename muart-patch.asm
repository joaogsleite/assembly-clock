...
PLACE		1000H
pilha:		TABLE 100H		; espaÁo reservado para a pilha
					
SP_inicial:				; endereÁo de inicializaÁ„o do Stack Pointer
...
varrermuart:	PUSH	R0
		...
		MOV	R1, M1_RD2		; prepara acesso ao RDU2
		MOV	R0, ' '			; escreve um espaço
		MOVB	[R1], R0		; para iniciar a transmissão e separar caracteres
		JMP	fimvarmuart
